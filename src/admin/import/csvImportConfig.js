...
export const IMPORT_CONFIGS = {
    ...
    field_records: {
        ...
        columns: [
            ...
            col('treatment', 'Treatment', 'string', false),
            col('campaign', 'Campaign', 'string', false),
            ...
            col('total_carbon', 'Total carbon (g/kg)', 'number', false),
            col('total_organic_carbon', 'Total organic carbon (g/kg)', 'number', false),
            col('total_nitrogen', 'Total nitrogen (g/kg)', 'number', false),
    ...
    dna: {
        ...
        columns: [
            ...
            col('volume', 'Volume', 'number', false),
            col('concentration', 'Concentration', 'number', false),
            col('description', 'Description', 'string', false),
        ],
    },
};
